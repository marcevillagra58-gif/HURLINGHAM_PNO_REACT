    ...
    localities: [
        {
            ...
            images: [
                "/assets/Historia/hist-hurl-1.jpg",
                "/assets/Historia/hist-hurl-2.jpg"
            ],
            hotspot: { top: '33%', left: '55%', width: '20%', height: '18%' }
        },
        {
            id: 'tesei',
            title: 'Villa Tesei',
            ...
            images: [
                "/assets/Historia/hist-tes-1.jpg",
                "/assets/Historia/hist-tes-2.jpg"
            ],
            hotspot: { top: '65%', left: '53%', width: '20%', height: '18%' }
        },
        {
            id: 'morris',
            ...
            images: [
                "/assets/Historia/hist-morr-1.jpg",
                "/assets/Historia/hist-morr-2.jpg"
            ],
            hotspot: { top: '28%', left: '25%', width: '20%', height: '18%' }
        }
    ]
};
